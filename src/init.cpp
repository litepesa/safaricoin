    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Safaricoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  safaricoind [options]                     " + "\n" +
                  "  safaricoind [options] <command> [params]  " + _("Send command to -server or safaricoind") + "\n" +
                  "  safaricoind [options] help                " + _("List commands") + "\n" +
                  "  safaricoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: safaricoind.pid)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 2223 or testnet: 12223)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Safaricoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Safaricoin is probably already running."), strDataDir.c_str()));
